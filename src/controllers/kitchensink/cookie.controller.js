...
const setCookie = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(
        new ApiResponse(200,{cookies : {...req.cookies,...cookieObject}},"Cookie has been set")
    )
})
...
const removeCookie = asyncHandler(async(req,res)=>{
    ...
    return res.status(200).json(
        new ApiResponse(200,{cookies : {...req.cookies,[cookieKey]:undefined}},"Cookie has been cleared")
    )
});
